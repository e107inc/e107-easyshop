...
"ALTER TABLE ".MPREFIX."easyshop_preferences ADD fixed_order_fee varchar(1) NOT NULL default '' AFTER main_categories_per_page;",
"ALTER TABLE ".MPREFIX."easyshop_preferences ADD fixed_order_fee_text varchar(200) NOT NULL default '' AFTER fixed_order_fee;",
"ALTER TABLE ".MPREFIX."easyshop_preferences ADD fixed_order_fee_amount FLOAT NOT NULL AFTER fixed_order_fee_text;",
"ALTER TABLE ".MPREFIX."easyshop_preferences ADD fixed_order_fee_shipping FLOAT NOT NULL AFTER fixed_order_fee_amount;",
"ALTER TABLE ".MPREFIX."easyshop_preferences ADD fixed_order_fee_shipping2 FLOAT NOT NULL AFTER fixed_order_fee_shipping;",
"ALTER TABLE ".MPREFIX."easyshop_preferences ADD fixed_order_fee_handling FLOAT NOT NULL AFTER fixed_order_fee_shipping2;"
);
